...
describe(`SpecTransformer`, () => {
  test(`transform`, () => {
      ...
      components: {
        schemas: {
          Schema: {
            ...
            required: [`TodoState`, `TodoItemId`, `TodoItem`, `TodoItems`, `TodoItemsGroupedByStatus`, `FortyTwo`],
            additionalProperties: false
          }
        }
      },
    ...
    const transformedSpec = t.transform({
      mergeRefs: [{
        $ref: `Schema#/properties/TodoState`
      }]
    });
...
//# sourceMappingURL=SpecTransformer.test.js.map